...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const FOOD_DB = [
        ...
        // Реально сourced позиции — таблица калорийности «Цех 85» с health-diet.ru (юзер прислал
        // ссылку). ВАЖНО: там значения ВСЕГДА на 100г продукта (сайт сам так их даёт), а не на
        // порцию/чашку/штуку — поэтому в имени явно оставлено «100г», как и у остальных весовых
        // позиций в базе, чтобы не выдавать эти цифры за калорийность целой булочки/чашки.
        { name: 'Американо, 100г', kcal: 4, source: 'Цех 85' },
        { name: 'Капучино, 100г', kcal: 64, source: 'Цех 85' },
        { name: 'Латте, 100г', kcal: 62, source: 'Цех 85' },
        { name: 'Латте декаф, 100г', kcal: 60, source: 'Цех 85' },
        { name: 'Латте с имбирным пряником, 100г', kcal: 89, source: 'Цех 85' },
        { name: 'Латте с кедровым орехом, 100г', kcal: 99, source: 'Цех 85' },
        { name: 'Матча латте, 100г', kcal: 60, source: 'Цех 85' },
        { name: 'Флэт уайт, 100г', kcal: 66, source: 'Цех 85' },
        { name: 'Круассан классический, 100г', kcal: 394, source: 'Цех 85' },
        { name: 'Круассан с шоколадом, 100г', kcal: 371, source: 'Цех 85' },
        { name: 'Булочка с корицей, 100г', kcal: 279, source: 'Цех 85' },
        { name: 'Булочка шу, 100г', kcal: 294, source: 'Цех 85' },
        { name: 'Брауни классика, 100г', kcal: 370, source: 'Цех 85' },
        { name: 'Багет классический, 100г', kcal: 200, source: 'Цех 85' },
        { name: 'Чиабатта, 100г', kcal: 155, source: 'Цех 85' },
        { name: 'Сэндвич ветчина с сыром чеддер, 100г', kcal: 161, source: 'Цех 85' },
        { name: 'Ролл с цыплёнком, 100г', kcal: 155, source: 'Цех 85' },
        { name: 'Ролл итальянский цыплёнок, 100г', kcal: 253, source: 'Цех 85' },
        { name: 'Ролл снежный краб, 100г', kcal: 179, source: 'Цех 85' },
        { name: 'Салат Цезарь с томатами черри, 100г', kcal: 145, source: 'Цех 85' },
        { name: 'Салат с киноа и яблоком, 100г', kcal: 74, source: 'Цех 85' },
        { name: 'Салат печёный грик, 100г', kcal: 100, source: 'Цех 85' },
        { name: 'Йогурт натуральный, 100г', kcal: 66, source: 'Цех 85' },
        { name: 'Чизкейк, 100г', kcal: 331, source: 'Цех 85' },
        { name: 'Медовик классический, 100г', kcal: 310, source: 'Цех 85' }
    ];
