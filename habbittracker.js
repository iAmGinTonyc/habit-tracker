...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //   - правая ~20% кнопки — полоска с ИНВЕРТИРОВАННЫМ фоном и текстом «PRO MODE»/«BASE MODE»
    //     в две строки, повёрнутым на 90°; золото на чёрном, синий на белом (вся раскраска — в
    //     CSS, см. .vb-promode-label);
